...
#	fout_script.write('scale=%f \n'%scale)
    ...
    fout_script.write('$ReM_{visdtau}>230GeV$& %d & %.3f \%% \\\ \n'  %(event[8],(event[8]/event[0])*100))
    fout_script.write(' \hline \n')
    fout_script.write(' \hline \n')
...
#	fout_script.write('scale=%f \n'%scale)
    ...
    fout_script.write('$ReM_{visdtau}>230GeV$  and Impact_{Tau}$<$0.0011& %d & %.3f \%% \\\ \n'  %(event[8],(event[8]/event[0])*100))
    fout_script.write(' \hline \n')
    fout_script.write(' \hline \n')
    fout_script.write(' \end{tabular} \n')
    fout_script.write(' \end{center} \n')
...
#	fout_script.write('scale=%f \n'%scale)
    ...
    fout_script.write('$P_{visible}<58GeV$s& %d & %.3f \%% \\\ \n'  %(event[6],(event[6]/event[0])*100))
    fout_script.write('$N_{neutral}>15,N_{electron}<7$ & %d & %.3f \%% \\\ \n'  %(event[7],(event[7]/event[0])*100))
    fout_script.write('$N_{IsoMuon}=0,N_{IsoElectron}=0$ & %d & %.3f \%% \\\ \n'  %(event[8],(event[8]/event[0])*100))
    fout_script.write(' \hline \n')
    fout_script.write(' \hline \n')
    fout_script.write(' \end{tabular} \n')
    fout_script.write(' \end{center} \n')
...
#	fout_script.write('scale=%f \n'%scale)
    ...
    fout_script.write('$85GeV<M_{visible}<102GeV$ & %d & %.3f \%% \\\ \n'  %(event[4],(event[4]/event[0])*100))
    fout_script.write('$\Delta\phi_{dijet}<175$\degree& %d & %.3f \%% \\\ \n' %(event[5],(event[5]/event[0])*100))
    fout_script.write('$P_{visible}<58GeV$& %d & %.3f \%% \\\ \n'  %(event[6],(event[6]/event[0])*100))
    fout_script.write('$N_{neutral}>15,N_{electron}<7$ & %d & %.3f \%% \\\ \n'  %(event[7],(event[7]/event[0])*100))
    fout_script.write('$N_{IsoMuon}=0,N_{IsoElectron}=0$& %d & %.3f \%% \\\ \n'  %(event[8],(event[8]/event[0])*100))
    fout_script.write(' \hline \n')
    fout_script.write(' \hline \n')
