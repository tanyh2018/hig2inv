...
#        self.h_before_cut_costhep= ROOT.TH1F('before_cut_costhep','before_cut_costhep',60,-1,1)
        ...
        self.h_after_first_cut_Mrecoil = ROOT.TH1F('after_first_cut_Mrecoil','after_first_cut_M_{Recoil}',140,0,250)
...
#        #Fill root branches after cutting
    ...
    def fill_root(self,t_in,t_out):
        m_m_recoil=math.sqrt(240*240-2*240*math.sqrt(91.2*91.2+t_in.m_p_dimu*t_in.m_p_dimu)+91.2*91.2)
